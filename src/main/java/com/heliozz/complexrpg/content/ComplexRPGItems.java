package com.heliozz.complexrpg.content;
...
import com.heliozz.complexrpg.content.items.CrimsonDaggerItem;
...
public class ComplexRPGItems {
	private static final Map<String, Type> MAP = new HashMap<String, Type>();
	
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ComplexRPG.MODID);
	
	public static final DeferredRegister<Item> SPAWN_EGGS = DeferredRegister.create(ForgeRegistries.ITEMS, ComplexRPG.MODID);
