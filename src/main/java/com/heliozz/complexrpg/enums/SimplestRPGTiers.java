package com.heliozz.complexrpg.enums;
...
public enum SimplestRPGTiers implements Tier {
	...
	SimplestRPGTiers(int harvestLevel, int uses, float efficiency, float attackDamage, int enchantability, String repairMaterial) {
        this(harvestLevel, uses, efficiency, attackDamage, enchantability, ForgeRegistries.ITEMS.getValue(new ResourceLocation(ComplexRPG.MODID, repairMaterial)));
    }
