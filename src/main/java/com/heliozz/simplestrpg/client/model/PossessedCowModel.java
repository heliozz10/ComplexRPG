...
public class PossessedCowModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SimplestRPG.MODID, "possessed_cow"), "main");
	...
	public PossessedCowModel(ModelPart root) {
