...
public class SimplestRPGMobs {
	...
	public static final RegistryObject<EntityType<Stonecrawler>> STONECRAWLER = registerEntity(Stonecrawler::new, "stonecrawler", 0.9F, 1.4F, 0xFFFFFF, 0xFFFFFF, MobCategory.MONSTER);
